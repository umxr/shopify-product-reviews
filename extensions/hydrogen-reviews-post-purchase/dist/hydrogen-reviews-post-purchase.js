...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  var ExtensionInputContext = /* @__PURE__ */ (0, import_react17.createContext)(null);

  // node_modules/.pnpm/@shopify+post-purchase-ui-extensions-react@0.13.4_react@17.0.2/node_modules/@shopify/post-purchase-ui-extensions-react/build/esm/hooks/input.mjs
  function useExtensionInput() {
    var input = (0, import_react18.useContext)(ExtensionInputContext);
    if (input == null) {
  ...
  var APP_URL = "https://puzzles-aaron-endless-officials.trycloudflare.com";
  ...
  function App() {
    ...
    const [nameError, setNameError] = (0, import_react20.useState)("");
    const [rating, setRating] = (0, import_react20.useState)("");
    const [ratingError, setRatingError] = (0, import_react20.useState)("");
    const [message, setMessage] = (0, import_react20.useState)("");
    const [messageError, setMessageError] = (0, import_react20.useState)("");
    ...
    const handleNameChange = (0, import_react20.useCallback)((value) => setName(value), []);
    const handleNameBlur = (0, import_react20.useCallback)(() => {
      if (!name) {
    ...
    const handleRatingChange = (0, import_react20.useCallback)((value) => {
      if (!value) {
    ...
    const handleMessageChange = (0, import_react20.useCallback)((value) => setMessage(value), []);
    const handleMessageBlur = (0, import_react20.useCallback)(() => {
      if (!message) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { spacing: "loose", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        Layout2,
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Image2, { source: (_a = selectedProduct == null ? void 0 : selectedProduct.featuredImage) == null ? void 0 : _a.url }) }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, {}),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { spacing: "xloose", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TextContainer2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { children: selectedProduct == null ? void 0 : selectedProduct.title }) }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Form2, { onSubmit: handleSubmit, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(FormLayout2, { children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { disabled: isSubmitDisabled, submit: true, children: "Submit" })
              ] }) })
            ] })
          ]
        }
